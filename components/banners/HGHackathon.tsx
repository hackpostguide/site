...
const HGHackathonBanner = () => {
  ...
  return (
    <div className="bg-orange-300 text-black text-left sm:text-center font-bold p-3 relative">
      ...
      <Link target="_blank" rel="noopener noreferrer" href={siteConfig.links.hackathon} className="text-lg ml-2 underline" title="Join Team">
        <span className="text-default-600">Register now for fun and prizes </span>
      </Link>
      <button 
