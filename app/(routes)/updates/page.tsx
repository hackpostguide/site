  ...
  return (
    <div>
      ...
      <p>
        ...
        If you would like to contribute to the project, feel free to check out the GitHub repository (https://github.com/hackpostguide/site) and submit a pull request!
      </p>
    </div>
  )
}
